`mrbayes.mixed` <- 
function(x, file, nst = 6, rates = "invgamma", ngammacat = 4, nruns = 2, ngen = 1000000, printfreq = 100, samplefreq = 10,  nchains = 4, savebrlens = "yes", temp = 0.2, burnin = 10, contype = "allcompat", path = "/Applications/mrbayes-3.1.2/", run = TRUE){
	...
	if (run){
		...
		else 												system(paste("mrbayes ", file, ".bayes", sep = ""))
